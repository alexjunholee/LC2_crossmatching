...
class StreetDataset(data.Dataset):
    ...
    def __init__(self,
        ...
        super(StreetDataset, self).__init__()
...
class LabsDataset(StreetDataset):
    """KITTI dataset which uses the updated ground truth depth maps
    """
    def __init__(self, *args, **kwargs):
        super(LabsDataset, self).__init__(*args, **kwargs)

    def get_image_path(self, folder, frame_index):
        f_str = "{}{}".format(self.filenames[frame_index], self.img_ext)
        image_path = os.path.join(
            folder, self.data_path, f_str)
        return image_path